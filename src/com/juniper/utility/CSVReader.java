...
/**
 * This is utility class for reading input CSV files and convert it into 2D object array for data provider use
 *
 */
public class CSVReader {
	...
	/**
	 * Parameterized constructor for setting input file name
	 * @param filename
	 */
	...
	/**
	 * Method to read CSV file content.
	 * @return the content of file in form of 2D Object array
	 */
	public Object[][] readFile() {
		...
		try {
			...
			reader= new FileReader(URLDecoder.decode(ClassLoader.getSystemClassLoader().getResource(filename).getPath(), "utf8"));
